...
const signIn = () => {
    return (
        <div class="max-w-2xl mx-auto ">
            <div
                class="bg-white shadow-md border m-20 border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="space-y-6" action="#">
                    <h3 class="text-4xl text-center font-medium text-gray-900 dark:text-white">Sign in</h3>
                    <div>
                        <label htmlFor="email" class="text-xl  font-medium text-gray-900 block mb-2 dark:text-gray-300">Your email</label>
                    ...
                    <div>
                        <label htmlFor="password" class="text-xl  font-medium text-gray-900 block mb-2 dark:text-gray-300">Your password</label>
                    ...
                    <button type="submit" class="w-full text-white text-xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
                </div>
            </div>
        </div>
    );
